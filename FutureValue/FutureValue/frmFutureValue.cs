...
namespace FutureValue
{
    public partial class frmFutureValue : Form
    {
        ...
        //Exercise 8-2 adding 10/4 rect array Kyle Dooley 05/19/2022
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            try
            {
                if (IsValidData())
                {
                    ...
                    //Exercise 8-2 calculations Kyle Dooley 05/19/2022
                    decimal interestRatePercent = interestRateYearly / 100;
                    calculationsTable[row, 0] = monthlyInvestment.ToString("c");
                    calculationsTable[row, 1] = interestRateMonthly.ToString("p1");
        ...
        private void btnExit_Click(object sender, EventArgs e)
        {
            ...
            //Exercise 8-2 dialog box Kyle Dooley 05/19/2022
